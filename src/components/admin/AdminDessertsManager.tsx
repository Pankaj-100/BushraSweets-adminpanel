...
export function AdminDessertsManager() {
  ...
  const [formData, setFormData] = useState<Omit<AdminDessert, "id">>(
    initialDessertData
  );
  ...
  const handleEdit = (dessert: AdminDessert) => {
    ...
    setFormData({
      ...dessert,
      dessertImages: dessert.dessertImages.length
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        priceSingle: e.target.value === "" ? null : parseFloat(e.target.value),
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        priceDouble: parseFloat(e.target.value) ,
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        priceParty: parseFloat(e.target.value) ,
                      }))
                    }
                  />
                </div>
              ...
              <ImageUploadComponent
                value={formData.dessertImages[0]}
                onChange={(url) =>
                  setFormData((prev) => ({
                    ...prev,
                    dessertImages: [url],
              ...
              <Card className="overflow-hidden relative z-0">
                <div className="relative mt-2">
                  ...
                  <div className="absolute top-2 right-2 flex gap-2 z-10">
                    ...
                    <Badge
                      variant={dessert.isActive ? "default" : "secondary"}
                    >
      ...
      {desserts.length === 0 && (
        <Card className="p-12 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Get started by adding your first dessert
          </p>
          <Button onClick={() => setIsDialogOpen(true)}>
            <Plus className="h-4 w-4 mr-2" /> Add Your First Dessert
          </Button>
        </Card>
      )}
    </div>
