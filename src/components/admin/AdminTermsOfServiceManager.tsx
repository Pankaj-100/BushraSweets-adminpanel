...
export function AdminTermsOfServiceManager() {
  const { data: policyResponse, isLoading, refetch } = useGetTermsOfServiceQuery();
  ...
  const handleSave = async () => {
    ...
    try {
      await updateTermsOfService({ content }).unwrap();
          ...
          <DialogContent className="max-w-6xl w-full max-h-[90vh] flex flex-col">
            <DialogHeader>
              ...
              <DialogDescription className="text-lg">
                {content 
                  ? 'Update your terms of service content using the rich text editor.' 
                  : 'Create your terms of service content using the rich text editor.'
                }
              </DialogDescription>
            </DialogHeader>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold">Current Terms of Service</h3>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">No terms of service content</h3>
                <p className="text-muted-foreground mb-4">
                  Start by creating your terms of service content
                </p>
